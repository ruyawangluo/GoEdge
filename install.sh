...
get_platform_url() {
    local platform_id=$1
    case $platform_id in
        1) echo "https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/${BRANCH}/${FILE_PATH}" ;;
        2) echo "https://gitee.com/${REPO_OWNER}/${REPO_NAME}/raw/${BRANCH}/${FILE_PATH}" ;;
        3) echo "${GITEA_SERVER}/${REPO_OWNER}/${REPO_NAME}/raw/branch/${BRANCH}/${FILE_PATH}" ;;
    esac
}
